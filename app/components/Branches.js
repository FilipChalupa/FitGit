...
const LabelIcon = require('material-ui/svg-icons/action/label').default
const LabelOutlineIcon = require('material-ui/svg-icons/action/label-outline').default
const colors = require('material-ui/styles/colors')
const n = require('../utils/nodegit')
const getLocalBranches = n.getLocalBranches
